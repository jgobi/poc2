...
\fancyhead{}
\fancyhead[C] {Logisim-evolução gerada pelo documento em Wed Jan 04 15:18:18 BRT 2023}
\fancyfoot[C] {\thepage}
...
\karnaughmap{3}{$x$}{{$b$}{$a$}{$c$}}
{01111111}{
   \node[grp={LogisimKMapColor1}{1.8}{1.8}](n0) at(2,1) {};
   \node[grp={LogisimKMapColor2}{1.8}{1.8}](n1) at(3,1) {};
   \node[grp={LogisimKMapColor3}{3.8}{0.8}](n2) at(2,0.5) {};
}
\end{tikzpicture}
\end{center}
%===============================================================================
